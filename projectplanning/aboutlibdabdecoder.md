...
* **[`include/dab_decoder.h`](../include/dab_decoder.h)**:
...
* **[`src/core/dab_instance.c`](../src/core/dab_instance.c)**:
...
* **[`src/core/dab_internal.h`](../src/core/dab_internal.h)**:
...
* **[`src/core/bitstream_reader.c`](../src/core/bitstream_reader.c) / `.h`**:
...
* **[`src/dsp/dsp_math.c`](../src/dsp/dsp_math.c) / `.h`**:
...
* **[`src/dsp/dsp_neon.c`](../src/dsp/dsp_neon.c) / `.h`**:
...
* **[`src/automotive/dab_crc.c`](../src/automotive/dab_crc.c) / `.h`**:
  * ETSI EN 300 401 §12.2 CRC-16/CCITT ($x^{16} + x^{12} + x^5 + 1$, poly `0x1021`, init `0xFFFF`).
* **[`src/automotive/soft_mute.c`](../src/automotive/soft_mute.c) / `.h`**:
...
* **[`src/automotive/concealment.c`](../src/automotive/concealment.c) / `.h`**:
  * Multi-stage FSM:
...
* **[`src/automotive/pop_prevention.c`](../src/automotive/pop_prevention.c) / `.h`**:
  * Raised-cosine crossfade on signal resumption, eliminating pop/click transients ($|\Delta S| \le 120$).
* **[`src/automotive/aqi_engine.c`](../src/automotive/aqi_engine.c) / `.h`**:
...
* **[`src/codec_mp2/mp2_tables.c`](../src/codec_mp2/mp2_tables.c) / `.h`**:
...
* **[`src/codec_mp2/mp2_synth.c`](../src/codec_mp2/mp2_synth.c) / `.h`**:
  * 32-subband polyphase matrixing and 512-point synthesis window overlap-add filterbank.
* **[`src/codec_mp2/mp2_decoder.c`](../src/codec_mp2/mp2_decoder.c) / `.h`**:
